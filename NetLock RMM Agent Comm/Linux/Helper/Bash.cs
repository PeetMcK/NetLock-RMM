        ...
        public static string Execute_Script(string type, bool decode, string script, int timeout = 0) // 0 = 60 minutes, timeout in minutes
        {
            ...
            try
            {
                ...
                if (decode)
                {
                    ...
                    {
                        Logging.Error("Linux.Helper.Bash.Execute_Script", "Decoded script is empty", String.Empty);
                ...
                {
                    Logging.Debug("Linux.Helper.Bash.Execute_Script", "Script execution successful", $"Exit code: {exitCode}");
                }
